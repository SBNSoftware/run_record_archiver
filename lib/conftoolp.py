...
_bundled_libs = ['libstdc++.so.6.0.31', 'libz.so.1.3.1.zlib-ng', 'libzstd.so.1.5.6', 'libcrypto.so.3', 'libssl.so.3', 'libnghttp2.so.14.28.3', 'libcurl.so.4.8.0', 'libicudata.so.74.2', 'libicuuc.so.74.2', 'libboost_filesystem.so.1.82.0', 'libboost_program_options.so.1.82.0', 'libbson-1.0.so.0.0.0', 'libbsoncxx.so.3.8.0', 'libmongoc-1.0.so.0.0.0', 'libmongocxx.so.3.8.0', 'libartdaq-database_SharedCommon.so', 'libartdaq-database_BasicTypes.so', 'libartdaq-database_Overlay.so', 'libartdaq-database_JsonDocument.so', 'libartdaq-database_DataFormats_Json.so', 'libartdaq-database_DataFormats_Xml.so', 'libartdaq-database_DataFormats_Fhicl.so', 'libartdaq-database_StorageProviders.so', 'libartdaq-database_StorageProviders_FileSystemDB.so', 'libartdaq-database_StorageProviders_UconDB.so', 'libartdaq-database_StorageProviders_MongoDB.so', 'libartdaq-database_ConfigurationDB.so']
_loaded_libs = []
